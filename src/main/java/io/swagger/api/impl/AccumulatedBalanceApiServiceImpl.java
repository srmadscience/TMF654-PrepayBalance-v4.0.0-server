...
public class AccumulatedBalanceApiServiceImpl  extends AccumulatedBalanceApiService {
    ...
    public javax.ws.rs.core.Response listAccumulatedBalance(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AccumulatedBalanceApiServiceImpl_listAccumulatedBalance", fields,offset,limit);
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response retrieveAccumulatedBalance(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AccumulatedBalanceApiServiceImpl_retrieveAccumulatedBalance", id,fields);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
