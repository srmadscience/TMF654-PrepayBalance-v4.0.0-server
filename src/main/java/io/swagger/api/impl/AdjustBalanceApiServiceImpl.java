...
public class AdjustBalanceApiServiceImpl  extends AdjustBalanceApiService {
    ...
    public javax.ws.rs.core.Response createAdjustBalance(io.swagger.model.AdjustBalanceCreate body, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AdjustBalanceApiServiceImpl_createAdjustBalance", toJson(body));
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response deleteAdjustBalance(java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AdjustBalanceApiServiceImpl_deleteAdjustBalance", id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response listAdjustBalance(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AdjustBalanceApiServiceImpl_listAdjustBalance", fields,offset,limit);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response patchAdjustBalance(io.swagger.model.AdjustBalanceUpdate body, java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AdjustBalanceApiServiceImpl_patchAdjustBalance", toJson(body),id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response retrieveAdjustBalance(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("AdjustBalanceApiServiceImpl_retrieveAdjustBalance", id,fields);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
