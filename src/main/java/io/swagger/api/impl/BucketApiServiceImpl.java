...
public class BucketApiServiceImpl  extends BucketApiService {
    ...
    public javax.ws.rs.core.Response retrieveBucket(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("BucketApiServiceImpl_retrieveBucket", id,fields);
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response listBucket(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("BucketApiServiceImpl_listBucket", fields,offset,limit);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
