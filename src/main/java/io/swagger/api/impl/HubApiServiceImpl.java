...
public class HubApiServiceImpl  extends HubApiService {
    ...
    public javax.ws.rs.core.Response registerListener(io.swagger.model.EventSubscriptionInput body, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("HubApiServiceImpl_registerListener", toJson(body));
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response unregisterListener(java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("HubApiServiceImpl_unregisterListener", id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
