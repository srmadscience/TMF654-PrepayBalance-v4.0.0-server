...
public class ReserveBalanceApiServiceImpl  extends ReserveBalanceApiService {
    ...
    public javax.ws.rs.core.Response patchReserveBalance(io.swagger.model.ReserveBalanceUpdate body, java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("ReserveBalanceApiServiceImpl_patchReserveBalance", toJson(body),id);
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response createReserveBalance(io.swagger.model.ReserveBalanceCreate body, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("ReserveBalanceApiServiceImpl_createReserveBalance", toJson(body));
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response deleteReserveBalance(java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("ReserveBalanceApiServiceImpl_deleteReserveBalance", id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response retrieveReserveBalance(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("ReserveBalanceApiServiceImpl_retrieveReserveBalance", id,fields);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response listReserveBalance(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("ReserveBalanceApiServiceImpl_listReserveBalance", fields,offset,limit);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
