...
public class TopupBalanceApiServiceImpl  extends TopupBalanceApiService {
    ...
    public javax.ws.rs.core.Response createTopupBalance(io.swagger.model.TopupBalanceCreate body, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TopupBalanceApiServiceImpl_createTopupBalance", toJson(body));
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response deleteTopupBalance(java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TopupBalanceApiServiceImpl_deleteTopupBalance", id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response listTopupBalance(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TopupBalanceApiServiceImpl_listTopupBalance", fields,offset,limit);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response patchTopupBalance(io.swagger.model.TopupBalanceUpdate body, java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TopupBalanceApiServiceImpl_patchTopupBalance", toJson(body),id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response retrieveTopupBalance(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TopupBalanceApiServiceImpl_retrieveTopupBalance", id,fields);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
