...
public class TransferBalanceApiServiceImpl  extends TransferBalanceApiService {
    ...
    public javax.ws.rs.core.Response createTransferBalance(io.swagger.model.TransferBalanceCreate body, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TransferBalanceApiServiceImpl_createTransferBalance", toJson(body));
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response deleteTransferBalance(java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TransferBalanceApiServiceImpl_deleteTransferBalance", id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response listTransferBalance(java.lang.String fields, java.lang.Integer offset, java.lang.Integer limit, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TransferBalanceApiServiceImpl_listTransferBalance", fields,offset,limit);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response patchTransferBalance(io.swagger.model.TransferBalanceUpdate body, java.lang.String id, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TransferBalanceApiServiceImpl_patchTransferBalance", toJson(body),id);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
    ...
    @SuppressWarnings("unchecked")
    public javax.ws.rs.core.Response retrieveTransferBalance(java.lang.String id, java.lang.String fields, javax.ws.rs.core.SecurityContext securityContext) throws io.swagger.api.NotFoundException {
        ...
        try {
            getClient();
            ClientResponse cr = c.callProcedure("TransferBalanceApiServiceImpl_retrieveTransferBalance", id,fields);
            StatusAndData sad = unloadVoltTable( cr, response_type);
            if (sad.statusCode == RESPONSE_CREATED) {
                objectToReturn = (javax.ws.rs.core.Response) sad.returnObject;
                return Response.ok().entity(objectToReturn).build();
